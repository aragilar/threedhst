...
__version__ = "$Rev: 358 $"
# $URL: https://threedhst.googlecode.com/svn/threedhst/spec1d.py $
# $Author: gbrammer $
# $Date: 2012-06-13 13:58:31 -0400 (Wed, 13 Jun 2012) $
...
lines = spWFindLines(SPCFile, idx=195, show=True, check_contam=False)
    ...
    if isinstance(SPCFile, threedhst.plotting.SPCFile):
        ...
        lam = SPCFile.lam*1.
        flux = SPCFile.flux/SPCFile.sens*1.e-17
        ferr = SPCFile.error/SPCFile.sens*1.e-17
        contam = SPCFile.contam/SPCFile.sens*1.e-17
